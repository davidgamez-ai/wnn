...
//Training on/off
export const TRAINING_CHECKBOX = "TrainingCheckbox";
//Modal buttons
...
export const LAYER_NAME_INPUT = "LayerNameInput";
export const LAYER_WIDTH_INPUT = "LayerWidthInput";
export const LAYER_HEIGHT_INPUT = "LayerHeightInput";
export const CONNECTIONS_PER_NEURON_INPUT = "ConnectionsPerNeuronInput";
export const NEURON_TYPE_INPUT = "NeuronTypeInput";
export const CONNECTION_PATTERN_INPUT = "ConnectionPatternInput";
